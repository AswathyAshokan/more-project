...
//                      
    ...
    //file upload
     displayFile=function(textboxId,fileTextBox,fileName,folderSpan,fileSpan) {
         console.log("display file");
         console.log("text1",textboxId.id);
         console.log("text2",fileTextBox.id);
         console.log("file id",fileName.id);
...
//         file    = document.querySelector('input[type=file]').files[0];
   ...
   saveEdit= function () {
    ...
    addFile= function (folderName,folderSpanId){
        ...
        $("#container").append(
     " <div class='folder'>" +"<span class='folder-name'>"+"<span></span>"+"</span>"+"<div class='file-name'>"+"<input class='form-control' id="+fileNewName+" type='text' placeholder='File Name'>"+"<button class='btn btn-primary margin-left-15'>Upload file  <input type='file' id="+uploadedFile+" onchange='displayFile("+folderNewName+","+fileNewName+","+uploadedFile+","+spanFolderName+","+spanFileId+");' >"+"</button>"+"<span id="+spanFileId+" style='position: absolute;margin-top: 25px;'></span>"+"</div>"+"<label  class='margin-left-15'></label>"); 
   ...
   addFileDup= function (id,folderName,folderSpan){
       ...
       var fileSpanId ='spanNewi'+fileCount;
         $("#"+name).append(
     " <div class='folder'>" +"<span class='folder-name'>"+"<span></span>"+"</span>"+"<div class='file-name'>"+"<input class='form-control' id="+fileId+" type='text' placeholder='File Name'>"+"<button class='btn btn-primary margin-left-15'>Upload file<input type='file' id="+uploadedFile+" onchange='displayFile("+uplodedFolder+","+fileId+","+uploadedFile+","+folderSpanId+","+fileSpanId+");'></button>"+"<span id="+fileSpanId+" style='position: absolute;margin-top: 25px;'></span>"+"</div>"+"<label  class='margin-left-15'></label>"); 
   }  
