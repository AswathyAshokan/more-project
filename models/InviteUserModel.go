...
func(m *InviteUser) DisplayUser(ctx context.Context) map[string]InviteUser {
	//user := User{}
	db,err :=GetFirebaseClient(ctx,"")
...
func(m *InviteUser) DeleteInviteUser(ctx context.Context, InviteUserId string) bool{
	//user := User{}
	db,err :=GetFirebaseClient(ctx,"")
...
func(m *InviteUser) EditInviteUser(ctx context.Context, InviteUserId string) (InviteUser,bool){
...
func(m *InviteUser) UpdateInviteUser(ctx context.Context,InviteUserKey string) (bool) {
